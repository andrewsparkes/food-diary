class ConsumableItemTypesController < ApplicationController
  before_action :set_consumable_item_type, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    if @consumable_item_type.save
      redirect_to @consumable_item_type, notice: 'Consumable item type was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    ...
    if @consumable_item_type.update(consumable_item_type_params)
      redirect_to @consumable_item_type, notice: 'Consumable item type was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to consumable_item_types_url, notice: 'Consumable item type was successfully destroyed.'
  end
